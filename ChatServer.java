...
public class ChatServer{
		public ArrayList <ServerThread> st = new ArrayList<ServerThread>();	// gets the clients so that we can send the string to each one
		...
		class ServerThread extends Thread{
				...
				public ServerThread(Socket _socket){
					s = _socket;	// gets the socket the other class
				}
